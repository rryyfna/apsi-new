...
### B. Modul Mahasiswa
- **Dashboard/Beranda:** (Perlu penyesuaian, konten awal dipindah ke fitur Monitoring).
...
### C. Modul Dosen
- **Dashboard/Beranda:** (Perlu penyesuaian, konten awal dipindah ke fitur Monitoring).
- **Monitoring:** Menampilkan ringkasan akademik dosen, dengan fitur export ke PDF.
...
- **Dashboard/Beranda:** (Perlu penyesuaian, konten awal dipindah ke fitur Monitoring).
- **Monitoring:** Fitur monitoring global, monitoring capaian CPL (Capaian Pembelajaran Lulusan), visualisasi grafik (Pie Chart), dengan fitur export laporan ke PDF.
- **Manajemen Master Data:** Fakultas, Prodi, Mahasiswa, Dosen, Mata Kuliah, Ruangan, Kurikulum.
